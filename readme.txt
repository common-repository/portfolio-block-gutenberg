=== Gutenberg Portfolio Block by CoBlocks ===
Author URI: https://coblocks.com
Plugin URI: https://coblocks.com
Contributors: coblocks, richtabor, thatplugincompany, themebeans
Donate link: https://themebeans.com
Tags: gutenberg, portfolio, gallery, post type, portfolio gallery
...
Showoff your works using the CoBlocks Portfolio Block within the upcoming Gutenberg WordPress Block Editor.
...
1. Upload the `portfolio-block-gutenberg` folder to your `/wp-content/plugins/` directory or alternatively upload the portfolio-block-gutenberg.zip file via the plugin page of WordPress by clicking 'Add New' and selecting the zip from your local computer.
2. Install and activate the Gutenberg WordPress plugin.
2. Activate the plugins through the 'Plugins' menu in WordPress.
3. Add your portfolio within Gutenberg with the new "Portfolio" block.
